...
const SPSection12 = ({ open, handleOpen, data, id }) => {
  ...
  useMemo(() => {
    if (data?.heading) {
      setValue("client_reviews.heading", data?.heading);
    }
    if (data?.sub_heading) {
      setValue("client_reviews.sub_heading", data?.sub_heading);
    }
    if (data?.heading_summary) {
      setValue("client_reviews.heading_summary", data?.heading_summary);
    }
  }, [data]);
        ...
        <AccordionBody>
          <form onSubmit={handleSubmit(handleSave)} className="w-full">
            <div className="mt-4">
              ...
              <input
                {...register("client_reviews.heading", {
                  required: true,
                })}
                type="text"
                required
            ...
            <div className="mt-4">
              ...
              <input
                {...register("client_reviews.sub_heading", {
                  required: true,
                })}
                type="text"
                required
            ...
            <div className="w-full h-full mt-4">
              ...
              <textarea
                {...register("client_reviews.heading_summary", {
                  required: true,
                })}
